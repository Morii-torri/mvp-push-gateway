...
func emailCapability(messageType string) Capability {
	return capability(capabilitySpec{
		...
		ChannelConfigSchema:  rawJSON(`{"type":"object","properties":{"from":{"type":"string","title":"发件人地址","format":"email"},"cc":{"type":"array","title":"抄送收件人地址","items":{"type":"string","format":"email"}},"bcc":{"type":"array","title":"密送收件人地址","items":{"type":"string","format":"email"}},"reply_to":{"type":"string","title":"指定回复地址","format":"email"}}}`),
