...
func emailCapability(messageType string) Capability {
	return capability(capabilitySpec{
		...
		CredentialSchema:     rawJSON(`{"type":"object","required":["service_provider","host","port","security","username","password"],"properties":{"service_provider":{"type":"string","title":"邮箱服务商","default":"custom","enum":["custom","qq","tencent_exmail","aliyun_qiye","netease_163","netease_126","gmail","outlook","office365"],"enum_labels":{"custom":"自定义","qq":"QQ邮箱","tencent_exmail":"腾讯企业邮箱","aliyun_qiye":"阿里企业邮箱","netease_163":"163邮箱","netease_126":"126邮箱","gmail":"Gmail","outlook":"Outlook","office365":"Office 365"}},"host":{"type":"string","title":"SMTP 主机地址","default":""},"port":{"type":"integer","title":"SMTP 端口","default":465},"security":{"type":"string","title":"加密方式","default":"SSL","enum":["SSL","STARTTLS"]},"username":{"type":"string","title":"用户名"},"password":{"type":"string","title":"授权码 / 密码","format":"password"}}}`),
