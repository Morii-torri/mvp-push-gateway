...
export const providers: ProviderRecord[] = [
  {
    ...
    providerType: 'ntfy',
    enabled: true,
    description: '自建订阅式推送服务',
    messageTypes: ['文本', 'Markdown'],
    recipientFields: 'topic',
    tokenStrategy: 'Bearer Token 可选',
    requestMethod: 'POST',
    requestUrl: 'https://ntfy.example.com/ops',
    tokenPlacement: 'Header: Authorization Bearer（可选）',
    rateLimit: '每秒 20 条',
    concurrency: 8,
    timeout: '3 秒',
    retryPolicy: '2 次固定间隔',
    deadLetterPolicy: '重试耗尽进入死信',
    lastTestResult: '2026-05-08 14:52 配置校验成功',
    capability: '文本、Markdown；接收人字段 topic',
  },
  {
    id: 'provider-2',
    name: '内部通知企业微信',
...
export const templates: TemplateRecord[] = [
  ...
  },
  {
    ...
    source: '市级业务系统',
    messageType: '富文本',
    targetProviderType: 'feishu_robot',
